  ...
  return (
    <div className="flex min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
         <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[60%] rounded-full bg-primary/20 blur-[120px] animate-pulse"></div>
         <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[70%] rounded-full bg-indigo-500/10 blur-[120px] animation-delay-2000"></div>
      </div>
        ...
        >
          ...
          <div className="bg-card border border-border p-8 rounded-[2rem] shadow-2xl shadow-slate-900/10 backdrop-blur-xl relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between px-1">
                   <label className="text-sm font-bold text-muted-foreground uppercase tracking-widest ml-1">Password</label>
                   <Link href="#" className="text-xs font-bold text-primary hover:text-primary-600">Forgot?</Link>
                </div>
                <div className="relative group">
                   <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="relative my-8">
               ...
               <div className="relative flex justify-center text-xs font-bold uppercase tracking-widest"><span className="bg-card px-4 text-muted-foreground">Or continue with</span></div>
            </div>

            <div className="grid grid-cols-2 gap-4">
               <button className="flex items-center justify-center gap-2 py-3 border border-border rounded-2xl hover:bg-muted transition-all font-bold text-sm">
          ...
          <p className="mt-8 text-center text-muted-foreground font-medium">
            New to MafynGate? <Link href="/register" className="inline-flex items-center gap-1 text-primary hover:text-primary-600 font-bold hover:underline underline-offset-4 decoration-2">Create an account <ArrowRight className="w-4 h-4" /></Link>
          </p>
        </motion.div>
      </div>

      {/* Side Image/Graphic area for larger screens */}
